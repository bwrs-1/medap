...
## 1. 目的
- メダカ愛好家が品種情報をいつでも参照できる図鑑機能
- 個人の飼育容器を管理し、容器ごとの品種構成を記録
- 複数ユーザーで品種情報を共同編集（権限管理）
...
- JWT有効期限: 7日
- HTTPS必須（Cloud Run）
- Sheets直アクセス禁止（API経由のみ）

### 5.4 配信
- AltStore/SideStoreで配布
- 署名は開発者個人のApple ID
